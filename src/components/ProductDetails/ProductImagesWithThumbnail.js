...
import ProductImagesThumbnail from "./ProductImagesThumbnail";

function ProductImagesWithThumbNail({ variantDetails }) {
  ...
  return (
    <div>
      <div className="hidden md:grid mt-[30px] gap-[20px]">
...
export default ProductImagesWithThumbNail;
